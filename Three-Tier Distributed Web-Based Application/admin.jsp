...
<html lang="en">
      ...
      <style type="text/css">
         <!--
            ...
            * {
            ...
            .bg-image {
             /* The image used */
             background-image: url("https://exite.co.za/wp-content/uploads/2017/08/Web-Background.jpg");
   ...
   <body>
      ...
      <div class="bg-text">
         ...
         <p>You are connected to the Project 4 Enterprise System as a root-level administrator.</p>
         <p>Please enter any valid SQL query or update command in the box below.</p>
         <br>
         <hr>
         <div class="container-fluid ">
            <row>
               <form action = "/project4/SQLQueryServlet" method = "post" class="text-center">
