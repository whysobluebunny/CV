...
{
    /// <summary>
    /// Class which represents enigma's wheel types
    /// </summary>
    ...
    public abstract class Wheel
    {
        ...
        public Action RotateNotchBack { get; set; }

        public Wheel(WheelType wheelType, int[] map, int[] notches)
        {
        ...
        public void RotateBack()
        {
            ...
            if (EnableNotch && Notches.Contains(Position))
            {
                if (RotateNotchBack != null) RotateNotchBack();
            }
        }
        ...
        public void SignalRightSide(int number)
        {
            ...
            if (SignalOutLeft != null)
            {
                ...
                output -= (Position - 1);
                if (output > 26) throw new InvalidOperationException();
                while (output < 1) output += 26;
                SignalOutLeft?.Invoke(output);
            }
        }
    ...
    public class Wheel_Gamma : Wheel
    {
